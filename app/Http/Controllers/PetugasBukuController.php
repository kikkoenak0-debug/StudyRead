...
class PetugasBukuController extends Controller
{
    ...
    public function index()
    {
        ...
        $view = 'petugas.kelola-buku.kelola-buku';
    ...
    public function create()
    {
        ...
        return view('petugas.kelola-buku.create', compact('kategori'));
    }
    ...
    public function edit($id)
    {
        ...
        $kategori = \App\Models\Kategori::all();
        return view('petugas.kelola-buku.edit', compact('buku', 'kategori'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('petugas.kelola-buku.index')->with('success', 'Buku berhasil ditambahkan');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('petugas.kelola-buku.index')->with('success', 'Buku berhasil dihapus');
    }
}
