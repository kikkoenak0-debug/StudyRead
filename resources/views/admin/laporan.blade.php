...
<body>
            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <div class="table-controls">
                        ...
                        <button class="btn btn-secondary btn-sm" style="margin-left:10px;" onclick="printSection('table-container')">🖨️ Print</button>
                    </div>
                </div>
    ...
    <script>
        ...
        // Print a specific section (by container id)
        function printSection(containerId) {
            ...
            w.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>Print - Laporan Pengembalian</title>${styles}</head><body>${el.outerHTML}</body></html>`);
            w.document.close();
            w.focus();
