...
<body>
    ...
    <main class="main-content">
        <div class="form-container">
            <h2>Edit Pengguna</h2>
            <form action="{{ route('admin.kelola-pengguna.update', $user) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    @if($user->foto)
                        <img src="{{ asset('storage/' . $user->foto) }}" alt="Foto Profil" style="max-width: 100px; margin-bottom: 10px;">
                    @endif
