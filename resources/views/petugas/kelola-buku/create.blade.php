...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <meta name="csrf-token" content="{{ csrf_token() }}">    <title>Tambah Buku - Admin</title>
...
<body>
    ...
    <main class="main-content">
        <div class="form-container">
            ...
            <form id="bookForm" action="{{ route('petugas.kelola-buku.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
